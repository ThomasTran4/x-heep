...
boolean P_CrossSubsector (int num)
{
    ...
    // check lines
    count = sub->numlines;
    seg = GetSeg(sub->firstline);//&segs[sub->firstline];
...
boolean P_CrossBSPNode (int bspnum)
{
                ...
                
    {
        ...
        recurse_bspnum = bsp.children[side^1];
    }
    return P_CrossBSPNode(recurse_bspnum);
}
